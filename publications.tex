...
\begin{enumerate}
    ...
    \item \textit{DAWN: Distributed Multi-Agent Workflow Synthesis via Federated Graph Learning} \\
    \textbf{Guancheng Wan}, Mo Zhou, Ziyi Wang, Xiaoran Shang, Eric Hanchen Jiang, Guibin Zhang, Jinhe Bi, Yunpu Ma, ZAIXI ZHANG, KE LIANG, Wenke Huang \\
    \hfill \textit{AAAI Conference on Artificial Intelligence} (\textbf{AAAI}), 2026

    \item \textit{Towards Robust Text-Attributed Federated Graph Learning: Multimodal Threats and Defense} \\
    Zitong Shi, \textbf{Guancheng Wan}, Wenke Huang, Yuxin Wu, QUAN ZHANG, Mang Ye \\
    \hfill \textit{AAAI Conference on Artificial Intelligence} (\textbf{AAAI}), 2026

    \item \textit{PurMM: Attention-Guided Test-Time Backdoor Purification in Multi-modal Large Language Models} \\
    Wenzheng Jiang, KE LIANG, Xuankun Rong, Jingxuan Zhou, Zhengyi Zhong, \textbf{Guancheng Wan}, Ji Wang \\
    \hfill \textit{AAAI Conference on Artificial Intelligence} (\textbf{AAAI}), 2026, {\color{red}{\textbf{Oral}}}

    \item \textit{Divide, Conquer and Unite: Hierarchical Style-Recalibrated Prototype Alignment for Federated Medical Segmentation} \\
    Xingyue Zhao, Wenke Huang, Xingguang Wang, Haoyu Zhao, Linghao Zhuang, Anwen Jiang, \textbf{Guancheng Wan}, Mang Ye \\
    \hfill \textit{AAAI Conference on Artificial Intelligence} (\textbf{AAAI}), 2026

    \item \textit{Domain-Aware Suppression and Aggregation for Federated DG ReID} \\
    Zhixi Yu, Wei Liu, Wenke Huang, Bin Yang, Qian Bie, \textbf{Guancheng Wan}, Xin Xu \\
    \hfill \textit{AAAI Conference on Artificial Intelligence} (\textbf{AAAI}), 2026
